...
export default function AddonsPage() {
  ...
  const filteredAddons = filterServiceId === "all"
    ? addons
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="flex items-center gap-2">
                        {addon.name}
                        {addon.is_required && <Badge variant="destructive" className="text-xs">Required</Badge>}
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete "{addonToDelete?.name}"? This will soft-delete the
              add-on (it won't appear for clients but existing orders will preserve the reference).
            </DialogDescription>
          </DialogHeader>
