    ...
    <div className="light:bg-white light:text-zinc-900 min-h-screen bg-zinc-950 font-sans text-white transition-colors duration-300">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-16 lg:grid-cols-2">
              ...
              <div className="space-y-8">
                <h2 className="light:text-zinc-900 text-4xl font-bold tracking-tight text-white">
                  Our Mission
                </h2>
              ...
              {/* Mission Cards */}
              <div className="space-y-6">
                <div className="light:border-zinc-900/10 light:bg-zinc-900/5 light:hover:border-zinc-900/20 light:hover:bg-zinc-900/10 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-white/20 hover:bg-white/10">
                  <div className="relative p-8">
                    <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-indigo-500 to-purple-600 text-white shadow-lg">
                ...
                <div className="light:border-zinc-900/10 light:bg-zinc-900/5 light:hover:border-zinc-900/20 light:hover:bg-zinc-900/10 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-white/20 hover:bg-white/10">
                  <div className="relative p-8">
                    <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-500 to-teal-600 text-white shadow-lg">
              ...
              {[
                ...
                >
                  <div className="relative p-8">
                    ...
                    <p className="light:text-zinc-600 relative text-sm text-zinc-400">
                      {feature.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {[
                ...
                >
                  <div className="relative p-8">
                    <div className="light:from-zinc-100 light:to-zinc-200 mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-zinc-800 to-zinc-900 backdrop-blur-xl">
                      <span className="light:text-zinc-900 text-white">{value.icon}</span>
                    </div>
                    <h3 className="light:text-zinc-900 mb-3 text-xl font-bold text-white">
                      {value.title}
                    </h3>
        ...
        <section className="relative overflow-hidden py-32">
          ...
          <div className="absolute inset-0 -z-10 hidden bg-linear-to-br from-indigo-900/10 to-purple-900/10 dark:block" />
          <div className="absolute inset-0 -z-10 block bg-linear-to-br from-indigo-50/50 to-purple-50/50 dark:hidden" />
