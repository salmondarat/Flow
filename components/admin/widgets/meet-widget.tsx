    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-dashboard-primary font-bold dark:text-white">Meet Schedule</h3>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="relative aspect-video overflow-hidden rounded-2xl bg-gray-200">
        ...
        <div className="absolute inset-0 flex items-end bg-black/10 p-3">
          <div className="flex w-full items-center justify-between">
            <span className="rounded-lg bg-black/20 px-2 py-1 text-[10px] text-white backdrop-blur-md">
              Preview
            </span>
            <div className="flex gap-2">
              <button className="flex h-6 w-6 items-center justify-center rounded-full bg-red-500">
              ...
              <button className="flex h-6 w-6 items-center justify-center rounded-full bg-white/20 backdrop-blur-md">
                <svg
      ...
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-dashboard-primary text-xs font-bold dark:text-white">{title}</h4>
        ...
        <button
          onClick={onJoin}
          className="border-dashboard-subtle flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[10px] font-bold transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
        >
          Join Meet
